...
This list contains some players that are not in the downloadable rating list and vice versa.
Optimally, we want to combine the two so all players are included.
